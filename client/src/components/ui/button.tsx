...
>(({ className, variant, size, isLoading = false, ...props }, ref) => {
  return (
    <Slot
      ...
      data-disabled={isLoading || props.disabled ? "" : undefined}
      {...props}
    >
      {props.children}
    </Slot>
...
// The main Button component that chooses between the implementations
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ asChild = false, ...props }, ref) => {
    if (asChild) {
      return <ButtonSlot {...props} ref={ref} />
    } 
    return <ButtonImpl {...props} ref={ref} />
  }
)
